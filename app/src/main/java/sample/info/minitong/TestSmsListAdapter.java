 ...
 */
public class TestSmsListAdapter extends ArrayAdapter<SmsInfo> {
    ...
    public TestSmsListAdapter(List<SmsInfo> msgList, Context ctx) {
        super(ctx, R.layout.msglist_fragment, msgList);
